<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucNewsComments.ascx.vb" Inherits="UserControl_ucNewsComments" %>
        ...
        $.prompt($(".FormAddAnswer").html(), {
            ...
            submit: function (e, v, m, f) {
                if (v) {
                    ...
                    var ParentId = id;
                    var NewsId = $('#<%= NewsIdSaver.ClientID %>').val();
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'ShowNews.aspx/AddNewItem',
                        data: '{"ParentId":"' + ParentId + '", "NewsId":"' + NewsId + '", "FullName":"' + FullName + '", "Email":"' + Email + '", "Note":"' + Note + '"}',
...
<div id="Comments">
    ...
    <div class="FormAddAnswer" title="افزودن نظر" style="display: none;">
        ...
        <asp:HiddenField ID="NewsIdSaver" runat="server" />
