<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ShowFuturePostDetail.aspx.vb" Inherits="Management_Admin_admin_software_ShowFuturePostDetail" %>
...
<body>
    ...
    <div style="margin-top: 10px 10px 10px 10px; direction:rtl;">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT tbl_Software_Post.PostId, tbl_Software_Post.Title, tbl_Software_Post.DescFarsi, tbl_Software_Category.CategoryName, tbl_Software_Post.BigImageFilename, tbl_Software_Post.DateOfCreatePost, tbl_Software_Post.LocationNumber, tbl_Software_Post.Hyperlink FROM tbl_Software_Category INNER JOIN tbl_Software_Post ON tbl_Software_Category.CategoryId = tbl_Software_Post.CategoryId WHERE (tbl_Software_Post.PostId = @PostId)">
            <SelectParameters>
